...
public class Toiletries extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mReg=FirebaseDatabase.getInstance().getReference().child("Material_Application").child("Toiletries").child(mFirebaseAuth.getInstance().getCurrentUser().getUid()).child("Sanitary Napkin");
        mreg2=FirebaseDatabase.getInstance().getReference().child("Material_Application").child("Toiletries").child(mFirebaseAuth.getInstance().getCurrentUser().getUid()).child("Soap");
        mreg3=FirebaseDatabase.getInstance().getReference().child("Material_Application").child("Toiletries").child(mFirebaseAuth.getInstance().getCurrentUser().getUid()).child("Diapers");
        ...
        cb11.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (cb11.isChecked()) {
                    ...
                    flag1=1;
                    need1=FirebaseDatabase.getInstance().getReference().child("Material_Application").child("Toiletries").child(mFirebaseAuth.getInstance().getCurrentUser().getUid()).child("Sanitary Napkin");
        ...
        cb2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (cb2.isChecked()) {
                    ...
                    flag2=1;
                    need2=FirebaseDatabase.getInstance().getReference().child("Material_Application").child("Toiletries").child(mFirebaseAuth.getInstance().getCurrentUser().getUid()).child("Soap");
                } else {
        ...
        cb3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (cb3.isChecked()) {
                    ...
                    flag3=1;
                    need3=FirebaseDatabase.getInstance().getReference().child("Material_Application").child("Toiletries").child(mFirebaseAuth.getInstance().getCurrentUser().getUid()).child("Diapers");
        ...
        cb4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (cb4.isChecked()) {
                    ...
                    flag4=1;
                    need4=FirebaseDatabase.getInstance().getReference().child("Material_Application").child("Toiletries").child(mFirebaseAuth.getInstance().getCurrentUser().getUid()).child("Disinfectant");
        ...
        cb5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (cb5.isChecked()) {
                    ...
                    flag5=1;
                    need5=FirebaseDatabase.getInstance().getReference().child("Material_Application").child("Toiletries").child(mFirebaseAuth.getInstance().getCurrentUser().getUid()).child("Blanket");
